...
subtitle: "Pooja Gokhale contributed to this excercise"
...
# Summary/Abstract
_This excercise was focused on learning how to work together in a single project with others with the help of forking in github._
...
_The dataset contains information on three variables height, weight, and gender. Two additional variables have been added to the original data, one is Country, representing the country of origin and the other is Age, representing the age in years_
...
#| tbl-cap: "NEW Linear model fit table."
#| echo: FALSE
resulttable3 = readRDS(here("starter-analysis-exercise","results","tables-files","resulttable3.rds"))
knitr::kable(resulttable3)
```
We can observe that none of the variable has a statistical significant impact on the outcome, implying that age and country does not have any statistical impact on height of the individual.


# The figures are contributed by Pooja Gokhale

## New Figure 1: Box Plot 


The following figure shows the boxplot of Height and Country. 
```{r}
#| label: fig-boxplot
#| fig-cap: "Height and Country boxplot."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","Height-vs-Country.png"))
```
It can be seen that height of different countries are not significantly different.
The height follows the distribution with Canada < Mexico < USA in average height of the individuals.


## New Figure 2: Scatterplot 
The following figure shows the scatterplot of Age against Weight. 
```{r}
#| label: fig-scatterplot
#| fig-cap: "Age Vs Weight scatterplot ."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","Age-vs-Weight.png"))
```
It can be seen that age and weight are positively correlated. The correlation is not clearly visible due to less datapoints but there is a pattern that increase in age results in increase in weight, which makes practical sense.
