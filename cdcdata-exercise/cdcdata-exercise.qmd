...
library(tidyverse) # loading tidyverse package  #loading readxl package
library(readxl)
...
str(cdc_dataset)
```
We have one (continuous) numeric variable in out dataset under that name "Data_Value". This variable actually represents the dollar amount of the revenue generated from cigarette sales. Another variable "Year" has also been coded as numeric. The rest of the variables are coded as character as they have alphabets as values including the TopicID and MeasureId variables.
